...
📧 jesse@reezon.io | 📞 410.440.3238 | 📄 <a href="../downloads/JesseFitzGibbon.20025.10.docx" target="_blank">Resume</a>
...
### **Reezon Technology (2025 – Present)**
**Founder & Principal Consultant**

**[Reezon Technology](https://reezon.io/)** is a boutique consulting practice focused on helping small businesses and nonprofits use technology with purpose — aligning tools, processes, and people so organizations can focus on the work that truly matters.

- Build and manage the firm, including service design, client engagement, delivery, and long-term strategy.  
- Provide fractional CTO support, technology assessments, and practical guidance on AI, cloud adoption, and workflow improvement.  
- Lead implementation planning and vendor/solution evaluation, helping clients make confident, well-informed decisions.  
- Deliver right-sized project management, modernization, and digital transformation support tailored to resource-constrained teams.  
- Serve organizations across the Baltimore–DC region with an emphasis on trust, transparency, and measurable value.
